...
,MAX(case when element_type = 'FC_INDUSTRY' then element_value end) AS FC_INDUSTRY
,MAX(case when element_type = 'FC_INDUSTRY_DESCRIPTION' then element_value end) AS FC_INDUSTRY_DESCRIPTION
...
,MAX(case when element_type = 'FC_PERMNAME' then element_value end) AS FC_PERMNAME
,MAX(case when element_type = 'FC_PRICING_DT' then element_value end) AS FC_PRICING_DT
,MAX(case when element_type = 'FC_PURPOSE' then element_value end) AS FC_PURPOSE
