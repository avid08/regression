...
where operation='INSERT' and resource_type = 'RATINGS_NAVIGATOR_INSTANCE'and ing.resource->>'Type'='BANK'
...
and ing.resource->'RNI'->'ThisEntity'->'ThisRatingAction'->0->'Factors'->4->'SubFactors'->2->>'IDX'='Cap&Lev';