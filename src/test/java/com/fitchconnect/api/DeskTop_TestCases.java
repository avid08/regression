...
public class DeskTop_TestCases {
  ...
  public void setUp() throws Exception {
    ...
    baseUrl = "https://login-qa2.fitchconnect.com/";
  ...
  public void testUntitled() throws Exception {
    ...
    driver.findElement(By.id("loginForm:username")).sendKeys("aminul.islam");
    driver.findElement(By.id("loginForm:password")).clear();
    driver.findElement(By.id("loginForm:password")).sendKeys("qa");
