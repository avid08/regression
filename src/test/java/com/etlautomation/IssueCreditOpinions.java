...
public class IssueCreditOpinions extends Configuration {
    ...
    private static HashMap<String, Document> runQueryAndProjection(String etlName){
    ...
    public void IssueCrdtOpinion_validatingSuccessfull_ETL_run() throws ParseException {

        try {
            MongoCollection<Document> Collection1 = mongoUtils.connectToMongoDatabase(Env.Mongo.FEEDS_PROD_PARALLEL)
            ...
            Block<Document> processBlock = new Block<Document>() {
                ...
                public void apply(final Document document) {
                    ...
                    if (etlrunStatus.equals("Success")) {
                        System.out.println("etl Ran successfully for IssueCreditOpinion Today");
                    } else {
                        failure = true;
                        System.out.println("etl Ran did not run  for IssueCreditOpinion Today");
                    }
    ...
    public void IssueCrdtOpinion_validating_rowProcessCountPer_LatestETLRun() throws ParseException {
        ...
        try {
            ...
            MongoCollection<Document> collection2 = mongoUtils.connectToMongoDatabase(Env.Mongo.FEEDS_QA)
                    .getDatabase("ids-dev-2").getCollection("issue_credit_opinions");
            ...
            Block<Document> processBlock1 = new Block<Document>() {
                ...
                public void apply(final Document document1) {
                    ...
                    System.out.println("totalcount "+issueCreditTotalCount);
    ...
    public void IssueCrdtOpinion_ValidateTheLatest_ETL_Rundate() throws ParseException {
